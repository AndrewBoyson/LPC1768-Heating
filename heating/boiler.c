...
#define BOILER_PUMP_DIR FIO2DIR_ALIAS(4) // P2.4 == p22
#define BOILER_PUMP_PIN FIO2PIN_ALIAS(4)
#define BOILER_PUMP_SET FIO2SET_ALIAS(4) = 1
#define BOILER_PUMP_CLR FIO2CLR_ALIAS(4) = 1

#define BOILER_CALL_DIR FIO2DIR_ALIAS(5) // P2.5 == p21
#define BOILER_CALL_PIN FIO2PIN_ALIAS(5)
#define BOILER_CALL_SET FIO2SET_ALIAS(5) = 1
#define BOILER_CALL_CLR FIO2CLR_ALIAS(5) = 1
